                ...
                <CardContent className="space-y-6">
                    ...
                    <div className="space-y-2 text-sm text-muted-foreground">
                        <ul className="list-disc pl-5 space-y-1">
                            <li>Connect one or more Gmail accounts to monitor incoming emails.</li>
                            <li>Get notified instantly when important messages arrive.</li>
                            <li>
                                Access is <strong>read-only</strong>. Disconnect anytime.
                            </li>
                        </ul>
                    </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="rounded-md border">
                                ...
                                <div className="grid grid-cols-12 gap-4 border-b bg-muted px-4 py-2 text-xs font-medium text-muted-foreground">
                                    <div className="col-span-4">Connection Name (eg. "Work Email")</div>
                                ...
                                {connections.map((conn, index) => (
                                    ...
                                    >
                                        ...
                                        <div className="col-span-5 text-muted-foreground flex items-center gap-2">
