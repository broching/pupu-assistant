...
import { CALENDER_SCOPES, calenderOauth2Client, GMAIL_SCOPES, oauth2Client, SSO_SCOPES } from "@/lib/google";
...
export async function GET(req: NextRequest) {
  try {
    ...
    const authUrl = calenderOauth2Client.generateAuthUrl({
      access_type: "offline",
      prompt: "consent",
      scope: CALENDER_SCOPES,
