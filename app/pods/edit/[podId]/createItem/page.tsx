...
import NearbyBuildingsInput from '@/components/common/MultiSelectCustomValueInput';
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const reqObj = {
                ...
                facilities: form.facilities || [], // already an array from tag input
                restrictions: form.restrictions || null,
                nearby_buildings: form.nearby_buildings || [], // directly use array
                listing_status: form.listing_status || "available",
                lease_term: form.lease_term || null,
                maintenance_fee: form.maintenance_fee
                    ? parseFloat(form.maintenance_fee)
                    : null,
                extra_information: form.extra_information || null,
            };

            await apiClient.post("/api/property_pod_items", reqObj);
    ...
    return (
        <div className="p-8 max-w-3xl mx-auto">
            ...
            <Card style={{ backgroundColor: 'var(--card)' }}>
                <CardHeader>
                    <CardTitle>Create New Pod Item</CardTitle>
                    <p className="text-sm text-muted-foreground mt-1">
                        Add a new item to this pod. This is what the bot will learn from.
                    </p>
                </CardHeader>
                <CardContent>
