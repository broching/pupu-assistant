...
import { Mail, Send, BadgeCheck } from "lucide-react";
...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    setLoading(true);
    Promise.all([checkTelegramLink(), fetchConnections()])
      ...
      <div className="space-y-6">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <Card className="flex flex-col justify-between">
            ...
            <CardContent>
              <Button asChild size="sm" className="w-full" disabled={loading}>
                <Link href="/integrations">Manage Telegram</Link>
              </Button>
            </CardContent>
          </Card>
          ...
          <Card className="flex flex-col justify-between">
            ...
            <CardContent>
              <Button asChild size="sm" className="w-full" disabled={loading}>
                <Link href="/integrations">Manage Gmail</Link>
              </Button>
            </CardContent>
          </Card>
